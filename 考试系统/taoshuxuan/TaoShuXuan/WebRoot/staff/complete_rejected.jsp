...
<script type="text/javascript" src="<%=request.getContextPath()%>/staff/js/audit_rejected.js" charset="utf-8"></script>
...
<%! 
	...
	String auditUrl = "complete_rejectedApply.do?rejectedApply.rejected_apply_id";
%>
<input id="url" value="show_rejectedApply.do?status=1" type="hidden"/>
<div id="breadNav">
        ...
        <td style="padding-right:10px;float:left"><div align="left" >
          <table border="0" align="right" cellpadding="0" cellspacing="0">
           ...
           <select name="m" class="search" id="se">
				<option value="customer.email">根据会员账号搜索</option>
				<option value="order.order_id">根据订单编号搜索</option>
				<option value="apply_date" id="time">根据时间段</option>
			</select>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">确认收货完成交易</span></strong></div></td>
      </tr>
      <s:iterator value="Record_l">
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="rejected_apply_id"/></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="customer.email"/></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="apply_date"/></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="apply_reason"/></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="showBookInOrder.do?order.order_id=<s:property value="order.order_id"/>"><s:property value="order.order_id"/></a></span></div></td>
     	<td height="22" bgcolor="#FFFFFF"><div align="center" class="STYLE5"><a href="<%=auditUrl %>" class="pass" name="${rejected_apply_id}">确认</a> </div></td>
 	</tr>
      </s:iterator>
