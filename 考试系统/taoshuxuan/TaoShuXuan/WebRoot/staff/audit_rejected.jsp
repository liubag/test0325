...
%>
<input id="url" value="show_rejectedApply.do?status=0" type="hidden"/>
<div id="breadNav">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="showBookInOrder.do?order.order_id=<s:property value="order.order_id"/>"><s:property value="order.order_id"/></a></span></div></td>
     	<td height="22" bgcolor="#FFFFFF"><div align="center" class="STYLE5"><a  href="<%=auditUrl%>" class="pass" name="${rejected_apply_id}">通过</a> | <a href="<%=auditUrl%>" class="unPass" name="${rejected_apply_id}">不通过</a></div></td>
 	</tr>
 	 </s:iterator>
	    </table></td>
	  </tr>
