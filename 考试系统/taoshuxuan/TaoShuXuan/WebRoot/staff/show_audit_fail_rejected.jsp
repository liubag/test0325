...
<body>
<input id="url" value="show_rejectedApply.do?status=2" type="hidden"/>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">退货申请状态</span></strong></div></td>
      </tr>
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="showBookInOrder.do?order.order_id=<s:property value="order.order_id"/>"><s:property value="order.order_id"/></a></span></div></td>
     	<td height="22" bgcolor="#FFFFFF"><div align="center" class="STYLE5"><a class="pass" name="${rejected_apply_id}" style="color: red">不通过</a> </div></td>
 	</tr>
      </s:iterator>
