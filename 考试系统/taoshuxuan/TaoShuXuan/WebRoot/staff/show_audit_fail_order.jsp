...
<body>
<input id="url" value="show_order.do?status=2" type="hidden"/>
<div id="breadNav">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center" class="STYLE5"><a href="#" class="pass" name="${order_id}">审核失败</a> </div></td>
      </tr>
      </s:iterator>
