...
<script type="text/javascript" src="<%=request.getContextPath()%>/staff/js/audit_order.js" charset="utf-8"></script>
...
<body>
<input id="url" value="show_order.do?status=0" type="hidden"/>
<div id="breadNav">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-right: 10px; float: left">
								<div align="left">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center" class="STYLE5"><a href="#" class="pass" name="${order_id}">通过</a> | <a href="#" class="unPass" name="${order_id}">不通过</a></div></td>
      </tr>
      </s:iterator>
