...
<div id="breadNav">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">申请编号</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">申请会员</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">申请时间</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">退货订单</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">退货状态</span></strong></div></td>
       ...
       <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="#"><s:property value="rejectedApply.rejected_apply_id"/></a> </span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="order.customer.name"/></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="rejectedApply.apply_date.toLocaleString()"/></span></div></td>       
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><s:property value="rejectedApply.order.order_id"/></span></div></td>
        <c:set var="status" scope="request" ><s:property value="rejectedApply.status"/></c:set>
        <c:choose>								
			<c:when test="${status == '0'}"><td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">等待审核</span></div></td></c:when>
			<c:when test="${status == '1'}"><td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">审请成功</span></div></td></c:when>
			<c:when test="${status == '2'}"><td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">审请失败</span></div></td></c:when>	
			<c:when test="${status == '3'}"><td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">收货中</span></div></td></c:when>	
			<c:when test="${status == '4'}"><td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">退货成功</span></div></td></c:when>									
		</c:choose> 
