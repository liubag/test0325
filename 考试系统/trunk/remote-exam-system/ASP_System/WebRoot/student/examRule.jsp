...
<script type="text/javascript">
	function doExam(){
		top.location.href="<%=request.getContextPath()%>/doExam.do?exam_id=<%=request.getParameter("exam_id")%>";
	}
</script>
</head>
<body>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  		<tr>
    		<td height="131" background="<%=request.getContextPath() %>/images/top_bg.jpg">sh <br></td>
 		</tr>
	</table>
...
<s:form action="" method="post">
 							<table align="center" width="100%" height="253"  border="0" cellpadding="0" cellspacing="0">
  								<tr>
    								<td height="81" colspan="3" align="center" class="word_orange1">${exam.exam_name}</td>
								</tr>
								<tr>
  								...
  								<tr>
    								<td align="center"><strong>答题时间&nbsp;</strong>${exam.exam_time} 分钟&nbsp;&nbsp;<strong>最短答题时间&nbsp;</strong>5分钟</td>
  								</tr>
  								<tr>
