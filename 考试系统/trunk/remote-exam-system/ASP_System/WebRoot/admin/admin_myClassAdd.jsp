...
<script type="text/javascript" src="<%=request.getContextPath()%>/admin/js/addClass.js" charset="utf-8"></script>
</head>
    			...
    			<td width="602" valign="top" bgcolor="#FFFFFF">
    				<table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      					<tr>
       						 <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin">
       						 	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           						 	<tr>
              							<td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">网管信息管理 &gt; 新增班级 &gt;&gt;&gt;</span></td>
      					...
      					<tr>
							...
							<s:form action="addMyClass.do" method="post">
  								<table width="70%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
  									 <tr><td><input type="hidden" id="oldName" value="<%=class_name %>"/></td></tr>
   									 <tr>   								
	   									<td align="center" style="padding:5px;">班级名称：</td>
   										<td align="left" width="60%"><input type="text" name="myClass.class_name" id="class_name" class="required1" size="20"/>      									
    								</tr>
