...
<script type="text/javascript" src="<%=request.getContextPath() %>/admin/js/updateCourse.js"></script>
</head>
<body>
    			...
    			<td width="602" valign="top" bgcolor="#FFFFFF">
    				<table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      					<tr>
       						 <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin">
       						 	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           						 	<tr>
              							<td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">网管信息管理 &gt; 修改科目 &gt;&gt;&gt;</span></td>
      					...
      					<tr>
							...
							<s:form action="updateCourse.do" method="post" >
  								<table width="63%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
  									 <tr><td><input type="hidden" name="course.course_id" value="<%=course_id %>"/></td></tr>
   									 <tr>
    									<td align="left" style="padding:5px;">科目名称：</td>
   										<td align="left"><input type="text" name="course.course_name" id="course_name" size="30" value="<%=course_name %>"/>
