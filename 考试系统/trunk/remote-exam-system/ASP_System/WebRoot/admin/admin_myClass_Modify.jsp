					...
					<table width="99%" height="487" border="0" cellpadding="0"
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="78%" class="word_grey">
											&nbsp;当前位置：
											<span class="word_darkGrey">网管信息管理 &gt; 修改班级
												&gt;&gt;&gt;</span>
										</td>
										<td align="right">
						...
						<tr>
							<td align="center" valign="top">
								...
								<s:form action="updateMyClass.do" method="post">
									<table width="80%" border="0" cellpadding="0" cellspacing="0"
										bordercolor="#FFFFFF" bordercolordark="#D2E3E6"
										bordercolorlight="#FFFFFF">
										<tr>
											<td>
												<input type="hidden" name="myClass.class_id"
													value="<%=class_id%>" />
											</td>
											<td><input type="hidden" id="oldName" value="<%=class_name %>"/></td>
										</tr>
										<tr>
											...
											<td align="left" width="70%">
												<input type="text" name="myClass.class_name" id="class_name" class="required1" size="20"
													value="<%=class_name%>" />
										</tr>
										...
										<tr>
											...
											<td>
												<input type="submit" class="btn_grey" id="send" value="保存" />
												&nbsp;
