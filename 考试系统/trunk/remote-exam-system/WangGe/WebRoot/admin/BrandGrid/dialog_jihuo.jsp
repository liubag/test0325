 ...
 <script type="text/javascript">
		 	$(function(){
			 	$("#sure").click(function(){
					...
					$("#rightIframe",window.parent.parent.parent.document.body).attr("src","brandgrid_jihuo.do?page=" + page + "&brandgrid_id=" + guuid + "&xuyue="+xuyue);
...
<body>
    <div id="shang">
    	...
    	<div class="div_title">品牌店： <%=gn %>       -->激活</div>
		<div class="div_1">租用月数：</div><div class="div_2"><input type="text" size="4" id="xuyue"/>个月</div>
