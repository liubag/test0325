			...
			$("#rightIframe",parent.document.body).height(height + 30);
			 ...
			 $("#send1").click(function(){
				...
				if(gn1 != null && gn1.length > 0){
					$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridOwner_by_page.do?page=1&brandgrid_id=0&brandgrid_gridOwnername="+gn1+"&owner_status=-1");
				}else{
					alert("请输入格主名.");
				}
			 });
			 $("#send2").click(function(){
				var uuid1 = $("#uuid1").val();
				var gnum = $("#gnum").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridOwner_by_page.do?page=1&brandgrid_id="+uuid1+"&brandgrid_gridOwnername="+gnum+"&owner_status=2");
			 });
			 $("#send3").click(function(){
				var uuid2 = $("#uuid2").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridOwner_by_page.do?page=1&brandgrid_id="+uuid2+"&brandgrid_gridOwnername=grid&owner_status=0");
			 });
		})
...
<div class="inbox">
  <table width="980" border="0">
        <tr>
          <td class="td_1">输入格主名：</td>
          <td class="td_2"><input type="text" maxlength="20" name="gn" id="gn1" value=""/></td>
		...
		<tr>
          <td class="td_1"></td>
          <td class="td_2"><input type="submit" value="查询" id="send1"/></td>
		  <td class="td_1"><span style=" font-size:16px; color:#FF0000">或</span>格主名：</td>
