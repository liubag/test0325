		...
		$(function(){
			...
			$("#rightIframe",parent.document.body).height(height + 30);
			 ...
			 $("#send2").click(function(){
				...
				var gnum = $("#gnum").val();
				var gn2 = $("#gn2").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllSellnote_by_page.do?page=1&brandgrid_id="+uuid1+"&grid_num="+gnum+"&grid_name="+gn2+"&owner_status=0&time=");
			 });
			 $("#send3").click(function(){
				var uuid2 = $("#uuid2").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllSellnote_by_page.do?page=1&brandgrid_id="+uuid2+"&grid_num=&grid_name=&owner_status=0&time=");
			 });
		})
