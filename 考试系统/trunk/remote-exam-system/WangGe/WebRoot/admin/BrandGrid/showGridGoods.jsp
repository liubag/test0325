			...
			$("#rightIframe",parent.document.body).height(height + 30);
			 ...
			 $("#send1").click(function(){
				...
				if(gn1 != null && gn1.length > 0){
					$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridGoods_by_page.do?page=1&brandgrid_id=0&goods_name="+gn1+"&owner_status=-1");
				}else{
					alert("请输入商品名称.");
				}
			 });
			 $("#send2").click(function(){
				var uuid1 = $("#uuid1").val();
				var gnum = $("#gnum").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridGoods_by_page.do?page=1&brandgrid_id="+uuid1+"&goods_name="+gnum+"&owner_status=5");
			 });
			 $("#send3").click(function(){
				var uuid2 = $("#uuid2").val();
				$("#_Iframe").attr("src","${pageContext.request.contextPath}/showAllGridGoods_by_page.do?page=1&brandgrid_id="+uuid2+"&goods_name=grid&owner_status=7");
			 });
		})
...
<div class="inbox">
  <table width="980" border="0">
		...
		<tr>
		  ...
		  <td class="td_1"><span style=" font-size:16px; color:#FF0000">或</span>商品名称：</td>
