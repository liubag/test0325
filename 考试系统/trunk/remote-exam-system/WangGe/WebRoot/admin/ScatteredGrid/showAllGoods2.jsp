  ...
  <div id="zhuanghu" style="margin-left: 15px">
	...
	<script type="text/javascript">
		...
		function test(select){
	  		$("#rightIframe",parent.document.body).attr("src","showAllGoods_by_page_admin_gridid.do?page="+select.value );
	  	}
	  	
	</script>
	<div>
		<div style="text-align: left;"><a href="javascript:history.go(-1);">返回上一步</a></div>
		<div>
